...
export async function updateChatSessionTitleAPI(sessionId, title) {
  return fetchWithAuth(`${API_BASE_URL}/chat/${sessionId}/title`, {
    // Or `${API_BASE_URL}/chat/${sessionId}` if using main PUT route
    method: "PUT",
